...
## Corpus Check
- 96 files · ~67,892 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1025 nodes · 1892 edges · 110 communities (53 shown, 57 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 29 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8a479cd6`
...
9. `buildPromotionDraftSnapshot()` - 14 edges
10. `loadEmployeeDashboard()` - 13 edges
...
## Communities (110 total, 57 thin omitted)

### Community 0 - "Dashboard Routing & Profiles"
Cohesion: 0.06
Nodes (71): getDashboardProfile(), getEmployeeDashboard(), getEvaluatorQueue(), router, applyEvidenceValidationToPromotionDraft(), applyRankIncrementRules(), buildDraftPointSummary(), buildEvidenceBasedScoreComputation() (+63 more)
...
Cohesion: 0.20
Nodes (23): getSupabase(), deleteDocument(), extractDocuments(), readJsonObject(), readOptionalString(), replaceDocument(), viewDocument(), ProcessedUploadResult (+15 more)
...
Cohesion: 0.08
Nodes (31): apiBaseUrl, buildApiUrl(), closeDocumentPreview(), documentPreviewFrame, documentPreviewMeta, documentPreviewModal, documentPreviewStatus, documentPreviewTitle (+23 more)
...
Cohesion: 0.14
Nodes (20): isOcrReadyFlag, ocrConfig, ocrScriptPath, publicDir, repoRoot, tqeCsvPath, tqeReferenceRecords, countLines() (+12 more)
...
Cohesion: 0.13
Nodes (25): escapeHtml(), formatDatabaseValue(), formatScorePreview(), getUploadedFilesFilterState(), getUploadTypeLabel(), loadDatabaseOverview(), matchesUploadedFileFilter(), renderDatabaseOverview() (+17 more)

### Community 11 - "Core TypeScript Types"
Cohesion: 0.07
Nodes (26): AppUserRole, AuthResponse, CycleMetrics, CycleMetricSummary, CycleMetricYearEntry, DocumentAnalysisResult, DocumentExtractionResult, EmployeeUploadType (+18 more)

### Community 12 - "API Fetch & Session Helpers"
Cohesion: 0.16
Nodes (24): apiFetch(), bootstrap(), buildApiUrl(), buildUploadNotice(), ensureSession(), getHomePathForRole(), handleDeleteUploadClick(), handlePanelUploadSubmit() (+16 more)
...
Cohesion: 0.07
Nodes (34): guidelinePdfPath, tqeReferenceSummary, academicRankAliases, academicRankOptions, attainmentAliases, educationalAttainmentOptions, normalizeAcademicRankOption(), normalizeEducationalAttainmentOption() (+26 more)
...
Cohesion: 0.13
Nodes (22): escapeHtml(), formatCriterionLabel(), formatKraShortLabel(), formatNumber(), formatOptionalNumber(), formatScoreWithMax(), getComputedStatusLabel(), renderComputedPanelScore() (+14 more)

### Community 17 - "Faculty & TQE Types"
Cohesion: 0.13
Nodes (22): FacultyIngestionPayload, FeatureSelectionResult, FeatureVector, Recommendation, SupportedModel, ThesisWorkflowResult, TqeBenchmarkMatch, analyzeDocumentContent() (+14 more)
...
Cohesion: 0.16
Nodes (13): env, envSchema, INSECURE_AUTH_SECRETS, ensureDocumentsBucket(), errorHandler(), router, upload, router (+5 more)
...
Cohesion: 0.39
Nodes (10): buildProfileArtifacts(), buildStoredFeatureEnvelope(), compareModels(), featureSelection(), generatePredictions(), ingestFaculty(), updateFaculty(), upsertDraftTrainingItem() (+2 more)
...
Cohesion: 0.18
Nodes (17): buildInsightSeries(), formatOptionalNumber(), getCoverageBucket(), getCoverageBucketLabel(), getPromotionBasisLabel(), getPromotionConfidenceLabel(), getPromotionStatusLabel(), getReviewQueueConfidenceValue() (+9 more)

### Community 28 - "Upload Document Handling"
Cohesion: 0.29
Nodes (14): apiFetch(), bootstrap(), deleteUploadDocument(), ensureDocumentPreviewShell(), handleUploadListActionClick(), handleUploadSubmit(), loadEmployeeWorkspace(), loadEvaluatorWorkspace() (+6 more)

### Community 29 - "Training Example Controller"
Cohesion: 0.62
Nodes (5): findBestMatchingProfile(), normalizeForMatch(), ProfileLinkCandidate, scoreProfileFilename(), tokenizeForMatch()

### Community 30 - "Admin & Review Routes"
Cohesion: 0.15
Nodes (15): prisma, getDatabaseOverview(), updateReviewStatus(), createTrainingExample(), getTrainingExamples(), attachSessionUser(), requireAuth(), requireRole() (+7 more)

### Community 31 - "Prediction Utility Functions"
Cohesion: 0.23
Nodes (13): buildFeatureVector(), calculateBaseProbability(), clamp(), compareModels(), findClosestTqeBenchmarks(), generateRecommendations(), inferPromotionOutcome(), mapEducationalAttainment() (+5 more)
...
Cohesion: 0.22
Nodes (14): labelTrainingExample(), TrainingExampleSubmission, createEvaluatorAssessment(), EvaluatorAssessment, parseEvaluatorAssessment(), readJsonObject(), readNumberRecord(), readOptionalNumber() (+6 more)
...
Cohesion: 0.11
Nodes (21): buildCycleMetricReviewCard(), buildCycleMetricValidations(), buildSummarySheetCriteriaSections(), buildSummarySheetFormalName(), buildSummarySheetPrintHtml(), buildSummarySheetSummaryMetrics(), collectSummarySheetValues(), downloadSummarySheetPdf() (+13 more)
...
## Knowledge Gaps
- **333 isolated node(s):** `name`, `private`, `version`, `type`, `dev` (+328 more)
...
- **Why does `prisma` connect `Admin & Review Routes` to `Dashboard Routing & Profiles`, `Supabase & Document Controller`, `Evaluator Assessment Utils`, `Auth Middleware & Env`, `Auth Controller & Tokens`, `Faculty ML Predictions`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `buildDraftPointSummary()` connect `Dashboard Routing & Profiles` to `Upload Panel Definitions`?**
