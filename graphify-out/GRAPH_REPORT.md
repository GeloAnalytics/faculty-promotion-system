# Graph Report - faculty-promotion-system  (2026-07-14)

## Corpus Check
- 102 files · ~60,603 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 874 nodes · 1507 edges · 105 communities (48 shown, 57 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 20 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5aac8dd4`
...
1. `escapeHtml()` - 24 edges
2. `buildDraftPointSummary()` - 23 edges
3. `Faculty Promotion System` - 22 edges
4. `compilerOptions` - 16 edges
5. `resolveOfficialRankOutcome()` - 16 edges
6. `compilerOptions` - 16 edges
7. `apiFetch()` - 14 edges
8. `buildPromotionDraftSnapshot()` - 14 edges
9. `loadEmployeeWorkspace()` - 12 edges
10. `loadEvaluatorWorkspace()` - 12 edges
...
Cohesion: 0.06
Nodes (72): reviewCycleMetricDefinitions, reviewCycleMetricKeys, reviewCycleYearLabels, getDashboardProfile(), getEmployeeDashboard(), getEvaluatorQueue(), router, applyEvidenceValidationToPromotionDraft() (+64 more)

### Community 1 - "Auth Portal Frontend (app.js)"
Cohesion: 0.12
Nodes (22): guidelinePdfPath, isOcrReadyFlag, ocrConfig, ocrScriptPath, publicDir, repoRoot, tqeCsvPath, tqeReferenceRecords (+14 more)

### Community 2 - "Supabase & Document Controller"
Cohesion: 0.18
Nodes (25): getSupabase(), deleteDocument(), extractDocuments(), readJsonObject(), readOptionalString(), replaceDocument(), viewDocument(), extractImageTextWithOcr() (+17 more)
...
Cohesion: 0.06
Nodes (40): adminAccountItems, adminAccounts, adminAccountsStatus, adminOverview, adminOverviewStatus, apiBaseUrl, buildApiUrl(), closeDocumentPreview() (+32 more)
...
Cohesion: 0.33
Nodes (9): calculateBaseProbability(), clamp(), compareModels(), findClosestTqeBenchmarks(), inferPromotionOutcome(), normalizeScore(), roundTo(), scoreModel() (+1 more)
...
Cohesion: 0.07
Nodes (26): AppUserRole, AuthResponse, CycleMetrics, CycleMetricSummary, CycleMetricYearEntry, DocumentExtractionResult, EmployeeUploadType, Express (+18 more)
...
Cohesion: 0.09
Nodes (26): tqeReferenceSummary, academicRankAliases, academicRankOptions, attainmentAliases, educationalAttainmentOptions, normalizeAcademicRankOption(), normalizeEducationalAttainmentOption(), normalizeKey() (+18 more)

### Community 16 - "Workflow Formatting Helpers"
Cohesion: 0.13
Nodes (23): escapeHtml(), formatCriterionLabel(), formatKraShortLabel(), formatNumber(), formatOptionalNumber(), formatScoreWithMax(), getComputedStatusLabel(), renderAdminOverview() (+15 more)

### Community 17 - "Faculty & TQE Types"
Cohesion: 0.11
Nodes (23): DocumentAnalysisResult, FeatureKey, featureKeys, FeatureVector, ModelComparisonResult, ModelMetrics, SupportedModel, analyzeDocumentContent() (+15 more)
...
Cohesion: 0.15
Nodes (14): env, envSchema, INSECURE_AUTH_SECRETS, ensureDocumentsBucket(), attachSessionUser(), SessionTokenPayload, errorHandler(), router (+6 more)
...
Cohesion: 0.47
Nodes (7): buildIdentityFeatureEnvelope(), compareModels(), featureSelection(), generatePredictions(), ingestFaculty(), updateFaculty(), attachExistingDocumentsToProfile()

### Community 28 - "Upload Document Handling"
Cohesion: 0.26
Nodes (20): apiFetch(), bootstrap(), deactivateAccountAction(), deleteAccountAction(), deleteUploadDocument(), ensureDocumentPreviewShell(), handleAccountsActionClick(), handleEmployeeProfileSubmit() (+12 more)

### Community 29 - "Training Example Controller"
Cohesion: 0.31
Nodes (8): createTrainingExample(), getTrainingExamples(), labelTrainingExample(), TrainingExampleSubmission, toPrismaJson(), serializeEvaluatorAssessment(), trainingLabelSchema, trainingSubmissionSchema

### Community 30 - "Admin & Review Routes"
Cohesion: 0.18
Nodes (14): prisma, assertNotLastManager(), deactivateAccount(), deleteAccount(), listAccounts(), reactivateAccount(), getDatabaseOverview(), updateReviewStatus() (+6 more)
...
Cohesion: 0.27
Nodes (12): buildTrainingAssessmentContext(), getLatestEvaluatorBackedTrainingItem(), getPreferredTrainingItem(), TrainingSelectionCandidate, createEvaluatorAssessment(), EvaluatorAssessment, parseEvaluatorAssessment(), readJsonObject() (+4 more)
...
Cohesion: 0.67
Nodes (3): prettyRole(), renderAccountRow(), renderAccountsPanel()
...
- **Why does `prisma` connect `Admin & Review Routes` to `Dashboard Routing & Profiles`, `Supabase & Document Controller`, `Auth Middleware & Env`, `Auth Controller & Tokens`, `Faculty ML Predictions`, `Training Example Controller`?**
...
- **Why does `uploadPanels` connect `Upload Panel Definitions` to `Dashboard Routing & Profiles`, `Supabase & Document Controller`, `Evaluator Assessment Utils`, `Faculty Rank Constants`, `Faculty & TQE Types`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Evaluator Criteria Rendering` to `package.json`, `pdf-parse`?**
